...
public class VideoPlayerWithAdPlayback {
    ...
    public VideoPlayerWithAdPlayback(VideoPlayer videoPlayer, ViewGroup
        adUiContainer)
    {
     ...
     */
    public VideoAdPlayer getVideoAdPlayer(){ return mVideoAdPlayer; }

    /**
     * Returns if an ad is displayed.
     */
    public boolean getIsAdDisplayed(){ return mIsAdDisplayed; }
